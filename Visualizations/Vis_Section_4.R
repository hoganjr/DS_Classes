...
fac <- reorder(fac, value, FUN = mean) #reorders by the mean value of each category (West = 5, Asia = 11)
levels(fac) 
...
#INCOME DISTRIBUTION OF WEST VERSUS DEVELOPOING WORLD, ONLY COUNTRIES WITH DATA
