...
#this code from previous vides defines the results object used for empirical Bayes election forecasting
...
#for exact 95% credible interval use qnorm(0.975)
mu <- 0
tau <- 0.035
sigma <- results$se
Y <- results$avg
...
#SIMULATED DATA WITH Xj = d + eps_j
J <- 6
N <- 2000
d <- .021
p <- (d+1)/2
...
#SIMULATED DATA WITH X_i,j = d + eps_i,j
I <- 5
J <- 6
N <- 2000
d <- .021
...
#SIMULATED DATA WITH X_i,j = d + h_i + eps_i,j
I <- 5
J <- 6
N <- 2000
d <- .021
